<?php
    ...
    function dataProcess($filename) {

        error_reporting(E_ERROR | E_PARSE);
	
        if (($handle = fopen("script2.csv", "r")) !== FALSE) {
                ...
                if($data[0] == "sell"){
                    ...
                    //Check if seller is a portfolio
                        ...
                        **************************************************************************************************/
                        ...
                        //if($portID == "8"){
                        //	echo "Total_cash for port is now $totalCash after portfolio sold stock in $gettingSold<br>";
                        //}
                    ...
                    if(!empty($indRowCheck)){
                        ...
                        **************************************************************************************************/
                        ...
                        $quoteQuery = mysqli_query($con, "SELECT Quote FROM quotes WHERE Date='$newDate' AND Stock_name='$buying'");
                        $row = $quoteQuery->fetch_assoc();
                        $quote = $row['Quote'];
    ...
    <body>
        ...
        <div class="container content">
            <h2><b>IMPORT RECORDS OF INDIVIDUAL/PORTFOLIO ACTIVITY</b></h2>
                <b> 
                    <?php
                        dataProcess($_POST['file']);
                        echo "<hr>Processing " . $_POST['file'] . " Completed<hr>";
                    ?>
