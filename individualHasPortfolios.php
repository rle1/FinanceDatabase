                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                                ...
                                array_push($entry, "Invested Portfolio Name");
                                ...
                                if ($_SESSION['all']) {
                                    ...
                                    if (mysqli_num_rows($indResults)) {
                                        while ($row = mysqli_fetch_array($indResults)) {
                                            ...
                                            $query = "SELECT portfolio.name AS P_Name FROM individual, portfolio, individual_has_portfolios WHERE individual.ID = individual_has_portfolios.Individual_ID and portfolio.ID = individual_has_portfolios.Portfolio_ID and individual.name =\"" . $individual . "\";";
                                            ...
                                            if (mysqli_num_rows($results)) {
                                                while ($row = mysqli_fetch_array($results)) {
                                                    ...
                                                    array_push($entry, $row["P_Name"]);
                                                    
                                                    array_push($data, $entry);
                                                    
                                                    echo "<tr><td>" . $individual . "</td>";
                                                    echo "<td>" . htmlentities($row["P_Name"]) . "</td></tr>";
                                                }
                                ...
                                $_SESSION['file'] = "individualHasPortfolios";
                                $_SESSION['data'] = $data;
